	...
	<div class="col-sm-10" style="margin: 1rem auto;">
		<ul class="nav nav-pills " id="myTab" role="tablist">
			<li class="nav-item"><a class="nav-link active" id="home-tab"
				...
				aria-selected="true"><span class="btn btn-primary">全部</span></a></li>
								...
								<tr style="line-height: 2em;">
									...
									<th>
										<div class="btn-group" role="group">
											<a href="FundPay?fnum=${item.fnum}" class="btn btn-success">查看详情</a>
											<a href="FundPay?fnum=${item.fnum}" class="btn btn-danger">买入</a>

	...
	<div class="container" style="margin-top: 20px;">
		...
		<form class="needs-validation" action="AddFundServlet" method="post">
			...
			<div class="row">
				...
				<div class="col-md-3 mb-3">
					<label for="jjgm">基金规模&emsp;&emsp;&emsp;&emsp;&emsp;<span
						class="graytext">(单位：亿元)</span></label> <input type="text"
			...
			<div class="row">
				<div class="col-md-2 mb-3">
					<label for="jjqg">起购价格<span class="graytext">&emsp;(单位:元)</span></label>
					<input type="text" class="form-control" value="100" name="fbuy"
						required>
				</div>
				<div class="col-md-2 mb-3">
					<label for="jjhl">购买汇率<span class="graytext">&emsp;&emsp;&emsp;&emsp;(%)</span></label>
					<input type="text" class="form-control" value="0.13"
						name="fbuyrate" required>
				</div>
				<div class="col-md-2 mb-3">
					<label for="基金类型">基金类型</label> 
					<select class="custom-select d-block w-100" name="ftype" required>

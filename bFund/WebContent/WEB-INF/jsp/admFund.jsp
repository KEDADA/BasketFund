								...
								<tr style="line-height: 2em;">
									...
									<th>
										<div class="btn-group" role="group">
											<a href="AdmFundInfo?fnum=${item.fnum}" class="btn btn-success">查看详情</a>
											<a href="AdmUpdateFund?fnum=${item.fnum}" class="btn btn-danger">修改信息</a>
											<a href="ChangeFundFlagServlet?fnum=${item.fnum}" οnclick="changefflagfct()"class="btn btn-warning">

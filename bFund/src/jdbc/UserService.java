...
//	获取链接
	...
	//findByUname
//	SELECT * FROM bfund.`user` WHERE uname = 'psyduck'
	...
	// 更新用户账户信息
//	UPDATE bfund.`user` set money=20000 where uid=1
	public static void updateMoney(String uname, BigDecimal money) {
		Connection conn = getConn();
		QueryRunner runner = new QueryRunner();

		String sql = "UPDATE bfund.user set money=? where uname=?";
	...
	public static void updateUflag(String uname,int uflag) {
		...
		String sql = "UPDATE bfund.user set uflag=? where uname=?";
